...
namespace ARPG.Gear
{
    [CreateAssetMenu(fileName = "Beard", menuName = "Traits/Beard", order = 1)]
    public class BeardTrait : FaceTrait, IEquipable
    {
        public void Equip(Equipment equipment)
        {
            ...
            EquipmentSlot slot = equipment.GetSlot(SlotType.Beard);
