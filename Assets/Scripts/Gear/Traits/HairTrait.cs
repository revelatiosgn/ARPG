...
namespace ARPG.Gear
{
    [CreateAssetMenu(fileName = "Hair", menuName = "Traits/Hair", order = 1)]
    public class HairTrait : FaceTrait, IEquipable
    {
        public void Equip(Equipment equipment)
        {
            ...
            EquipmentSlot slot = equipment.GetSlot(SlotType.Hair);
            ...
            EquipmentSlot headArmorSlot = equipment.GetSlot(SlotType.HeadArmor);
            if (headArmorSlot != null && headArmorSlot.EquipmentObject != null)
